# from player.wifi_ppo_player_torch import PPOPlayer
from player.wifi_ppo_slice_player_torch import PPOPlayer
...
player = PPOPlayer(identifier=identifier, max_num_unit_packet=3, observation_history_length=256,
                   ...
                   dnn_learning_rate=5e-6, scenario=1, modelNumber=27, clipping_val=0.2, entropy_beta=0.01,
                   lmbda=1, value_function_coef=0.5)
player.connect_to_server('127.0.0.1', 8000)
player.train_dnn(num_episodes=100, replay_memory_size=2000, mini_batch_size=1000, dnn_epochs=1,
